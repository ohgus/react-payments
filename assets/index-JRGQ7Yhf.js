...
const StyledButton = newStyled.button`
  ...
  position: ${({ position: position2 }) => position2 && position2};
  top: ${({ top }) => top && top};
...
const Home = () => {
  ...
  return /* @__PURE__ */ jsx$1(AppLayout, { children: /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: "20px", width: "80%", margin: "0 auto", children: [
    /* @__PURE__ */ jsx$1(Text, { variant: "Title", fontWeight: "bold", children: "우테코 자동 결제 서비스 이용을 위해" }),
    /* @__PURE__ */ jsx$1(Text, { variant: "Title", fontWeight: "bold", children: "카드 등록 페이지로 이동해주세요." }),
...
const StyledSelectBox = newStyled.ul`
  list-style: none;
...
const StyledSelectContainer = newStyled.div`
  ...
  ${({ isOpen }) => isOpen && css`
    ...
    `}
`;
const StyledSelected = newStyled.div`
  position: relative;
  top: 50%;
  left: 50%;
...
const CardBrandSelectForm = (props) => {
  return /* @__PURE__ */ jsx$1(
    CardInputLayout,
    {
      ...
      children: /* @__PURE__ */ jsx$1(Select, { options: cardBrandOptions, placeholder: "카드사를 선택하세요.", ...props })
    }
  );
};
...
const StyledCardTypeIcon = newStyled.img`
  ...
  height: 40px;
`;
const CardPreview = ({ cardNumbers, expireDate, cardBrand }) => {
  const cardTypeCheck = () => {
...
const StyledCompleteIcon = newStyled.div`
  width: 80px;
  height: 80px;
  background-color: ${colors.GY3};
  border-radius: 50%;
